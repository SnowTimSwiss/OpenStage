          ...
          {activeSection === "pdf" && (
            <div className="space-y-1">
              {pdfGroups.length === 0 ? (
                ...
                <p className="text-xs text-center py-4" style={{ color: "#666" }}>
                  Keine PowerPoint-Präsentationen gefunden.
                </p>
              ) : (
      ...
      return (
        <div className="space-y-2">
          <button
            ...
            className={`w-full aspect-video rounded-lg border-2 overflow-hidden transition-all hover:scale-[1.01] ${
              currentSlideIndex === 0
                ? "border-[#f97316] ring-2 ring-[#f9731640]"
                : "border-[#333] hover:border-[#555]"
            }`}
          >
            <div className="w-full h-full flex flex-col p-3 text-left">
              <div className="text-[8px] font-medium mb-1 uppercase tracking-wide" style={{ color: "#f97316" }}>
                Alle Strophen
              </div>
              <div className="flex-1 overflow-hidden">
                <p className="text-[9px] leading-tight whitespace-pre-line" style={{ color: "#ccc" }}>
                  {presentation.text.slice(0, 280)}
                  {presentation.text.length > 280 ? "..." : ""}
                </p>
              </div>
              <div className="text-[8px] mt-1" style={{ color: "#555" }}>
                1 / 1
              </div>
            </div>
          </button>
